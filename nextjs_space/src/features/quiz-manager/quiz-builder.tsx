...
function emptyQ(
  type: "single" | "multiple" | "truefalse" = "single"
): QuestionDraft {
...
export function QuizBuilder({
  ...
  async function generateWithAI() {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(
          data?.error ?? "Error generando preguntas"
        )
      }

      const newQuestions =
        (data.questions ?? []) as QuestionDraft[]
      ...
      toast.error(
        e.message ?? "Error generando preguntas"
      )
  ...
  async function save() {
    ...
    if (!name || questions.length === 0) {
      ...
      toast.error(
        "Completa el nombre y agrega preguntas"
      )
        ...
        <div className="grid md:grid-cols-3 gap-3">
          ...
          {([
...

            {
              ...
              desc: "Gemma local crea las preguntas",
            },

            {
              ...
              icon: Shuffle,
              title: "Mixto",
              desc: "Combina IA y edición manual",
            },
        ...
        <div className="bg-primary/5 p-6 rounded-lg shadow-sm">
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-display font-semibold">
              Generar con IA (Gemma local + RAG)
            </h3>
          ...
          <div className="grid md:grid-cols-[1fr,120px,auto] gap-3 items-end">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                value={aiCount}
                onChange={e =>
                  setAiCount(Number(e.target.value))
                }
              />
