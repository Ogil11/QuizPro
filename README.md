  ...
  nextjs_space/
    app/                         Next.js App Router pages and API routes
      api/
        ...
        feedback/generate/        AI feedback stub
...
- Result page AI feedback panel.
- Profile AI feedback panel.
- Feature READMEs for content upload, RAG, and AI feedback.
...
- AI feedback with Gemma is only a stub.
...
- Implement AI feedback from persisted attempts.
